...
# Install Python for gcloud CLI, bash for script execution, curl and jq for API interactions
RUN apt-get update && apt-get install -y python3 bash curl jq && apt-get clean
